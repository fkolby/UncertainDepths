...
python models/train_model.py in_debug=False save_images=True models=Posthoc_Laplace neural_net_param_multiplication_factor=32 hyperparameters.learning_rate=3e-4 transforms.rand_aug=False trainer_args.max_epochs=100 
